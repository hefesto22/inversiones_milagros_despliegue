...
use App\Filament\Resources\ClientePrecioResource\Pages;
...
class ClientePrecioResource extends \Filament\Resources\Resource
{
    protected static ?string $model = ClientePrecio::class;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('precio_venta')->label('Precio')
                    ->money('HNL')->sortable(),
                Tables\Columns\TextColumn::make('vigente_desde')->date()->sortable(),
                Tables\Columns\TextColumn::make('vigente_hasta')->date()->label('Hasta')->sortable()->placeholder('—'),
    ...
    {
        return [
            'index'  => Pages\ListClientePrecios::route('/'),
            'create' => Pages\CreateClientePrecio::route('/create'),
            'edit'   => Pages\EditClientePrecio::route('/{record}/edit'),
        ];
    }
}
