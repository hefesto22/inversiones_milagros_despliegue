 ...
 * para tolerar re-ejecuciones o DBs previamente parcheadas a mano.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('lotes', function (Blueprint $table) {
            if (!Schema::hasIndex('lotes', 'idx_lotes_producto_bodega_estado')) {
                $table->index(['producto_id', 'bodega_id', 'estado'], 'idx_lotes_producto_bodega_estado');
            }
            if (!Schema::hasIndex('lotes', 'idx_lotes_bodega_estado')) {
        ...
        Schema::table('compras', function (Blueprint $table) {
            if (!Schema::hasIndex('compras', 'idx_compras_bodega_estado')) {
        ...
        Schema::table('mermas', function (Blueprint $table) {
            if (!Schema::hasIndex('mermas', 'idx_mermas_lote_fecha')) {
                $table->index(['lote_id', 'created_at'], 'idx_mermas_lote_fecha');
            }
            if (!Schema::hasIndex('mermas', 'idx_mermas_bodega_fecha')) {
        ...
        Schema::table('compra_detalles', function (Blueprint $table) {
            if (!Schema::hasIndex('compra_detalles', 'idx_compra_detalles_compra')) {
        ...
        Schema::table('historial_compras_lote', function (Blueprint $table) {
            if (!Schema::hasIndex('historial_compras_lote', 'idx_historial_lote_fecha')) {
