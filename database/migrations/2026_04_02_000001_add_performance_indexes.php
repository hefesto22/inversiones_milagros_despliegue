 ...
 *
 * Idempotencia: cada índice se verifica con Schema::hasIndex() antes de agregarse.
 * Nota: el índice `idx_chofer_mov_tipo_created` apunta a columnas que ya tenían un
 * índice equivalente creado en `create_camiones_choferes_tables` (sin nombre explícito),
 * pero se mantiene aquí con nombre canónico para que las queries que lo referencian
 * por nombre sigan funcionando.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('viaje_ventas', function (Blueprint $table) {
            if (!Schema::hasIndex('viaje_ventas', 'idx_viaje_ventas_estado_fecha')) {
        ...
        Schema::table('ventas', function (Blueprint $table) {
            if (!Schema::hasIndex('ventas', 'idx_ventas_estado_created')) {
        ...
        Schema::table('compras', function (Blueprint $table) {
            if (!Schema::hasIndex('compras', 'idx_compras_created')) {
        ...
        Schema::table('camion_gastos', function (Blueprint $table) {
            if (!Schema::hasIndex('camion_gastos', 'idx_camion_gastos_estado_fecha')) {
        ...
        Schema::table('bodega_gastos', function (Blueprint $table) {
            if (!Schema::hasIndex('bodega_gastos', 'idx_bodega_gastos_estado_fecha_cat')) {
        ...
        Schema::table('viaje_mermas', function (Blueprint $table) {
            if (!Schema::hasIndex('viaje_mermas', 'idx_viaje_mermas_created')) {
        ...
        Schema::table('chofer_cuenta_movimientos', function (Blueprint $table) {
            if (!Schema::hasIndex('chofer_cuenta_movimientos', 'idx_chofer_mov_tipo_created')) {
        ...
        Schema::table('viajes', function (Blueprint $table) {
            if (!Schema::hasIndex('viajes', 'idx_viajes_estado_fecha_salida')) {
    ...
    public function down(): void
    {
        Schema::table('viaje_ventas', function (Blueprint $table) {
            if (Schema::hasIndex('viaje_ventas', 'idx_viaje_ventas_estado_fecha')) {
                $table->dropIndex('idx_viaje_ventas_estado_fecha');
            }
        });

        Schema::table('ventas', function (Blueprint $table) {
            if (Schema::hasIndex('ventas', 'idx_ventas_estado_created')) {
                $table->dropIndex('idx_ventas_estado_created');
            }
        });

        Schema::table('compras', function (Blueprint $table) {
            if (Schema::hasIndex('compras', 'idx_compras_created')) {
                $table->dropIndex('idx_compras_created');
            }
        });

        Schema::table('camion_gastos', function (Blueprint $table) {
            if (Schema::hasIndex('camion_gastos', 'idx_camion_gastos_estado_fecha')) {
                $table->dropIndex('idx_camion_gastos_estado_fecha');
            }
        });

        Schema::table('bodega_gastos', function (Blueprint $table) {
            if (Schema::hasIndex('bodega_gastos', 'idx_bodega_gastos_estado_fecha_cat')) {
                $table->dropIndex('idx_bodega_gastos_estado_fecha_cat');
            }
        });

        Schema::table('viaje_mermas', function (Blueprint $table) {
            if (Schema::hasIndex('viaje_mermas', 'idx_viaje_mermas_created')) {
                $table->dropIndex('idx_viaje_mermas_created');
            }
        });

        Schema::table('chofer_cuenta_movimientos', function (Blueprint $table) {
            if (Schema::hasIndex('chofer_cuenta_movimientos', 'idx_chofer_mov_tipo_created')) {
                $table->dropIndex('idx_chofer_mov_tipo_created');
            }
        });

        Schema::table('viajes', function (Blueprint $table) {
            if (Schema::hasIndex('viajes', 'idx_viajes_estado_fecha_salida')) {
                $table->dropIndex('idx_viajes_estado_fecha_salida');
            }
        });
    }
};
