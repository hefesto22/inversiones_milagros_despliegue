...
Route::middleware(['auth'])->group(function () {
    ...
    // Protegido con el MISMO permiso Shield del widget del dashboard:
    // solo quien puede ver el widget puede abrir/descargar el PDF
    // (contiene utilidades y el desglose de comisiones por chofer).
    Route::get('/pdf/estado-resultados', [EstadoResultadosPdfController::class, 'generate'])
        ->middleware('can:widget_EstadoResultados')
